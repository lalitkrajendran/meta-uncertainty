...
plot_unc_ratio_with_particle_removal_stereo(unc_ratio{trial_index}, unc_ratio_fit{trial_index}, ppr, individual_method_array, ...
                                            ...
                                            upper(metric_name), components, line_symbols, symbols, user_screen_resolution)
if save_figures
...
for component_index = 1:num_components
    for uncertainty_method_index = 1:num_individual_methods
        ...
        plot(bins_weights(1:end-1), pdf_weights{combination_method_index, uncertainty_method_index}(component_index, :), ...
            line_symbols{uncertainty_method_index}, 'color', [method_colors(1, :), 0.5])
        hold on
        % axis limits
...
make_violin_plot_error_uncertainty_all_comp_02(err_all_valid, unc_stereo_individual_all_valid, {unc_stereo_combined_all_valid{resampling_method_plot_index, :}}, ...
                                    rms_err, rms_unc_individual, rms_unc_combined, bins, ...
