...
% ===============================
%% calculate stereo uncertainty for individual and combined schemes
% ===============================
unc_stereo_individual = cell(1, num_trials);
unc_stereo_combined = cell(1, num_trials);
errors = cell(1, num_trials);
...
for trial_index = 1:num_trials
    ...
    % extract errors
    errors{trial_index}.x = errors_all.err_u(r_trial, c_trial, f_trial);
    errors{trial_index}.y = errors_all.err_v(r_trial, c_trial, f_trial);
    errors{trial_index}.z = errors_all.err_w(r_trial, c_trial, f_trial);
    ...
    % ================================================
    % loop through individual methods and propagate uncertainties
    % ================================================
    unc_stereo_individual{trial_index} = cell(1, num_uncertainty_methods);
    for individual_method_index = 1:num_uncertainty_methods
        % ================================================
        % extract planar uncertainties from resampling
        % ================================================
        % camera 1
        Unu1 = unc_planar_individual{1, trial_index}.([lower(uncertainty_method_array{individual_method_index}) 'x']);
        Unv1 = unc_planar_individual{1, trial_index}.([lower(uncertainty_method_array{individual_method_index}) 'y']);
        % camera 2
        Unu2 = unc_planar_individual{2, trial_index}.([lower(uncertainty_method_array{individual_method_index}) 'x']);
        Unv2 = unc_planar_individual{2, trial_index}.([lower(uncertainty_method_array{individual_method_index}) 'y']);
    ...
    % ================================================
    % loop through combined methods and propagate uncertainties
    % ================================================
    ...
    for combination_method_index = 1:num_combination_methods
        ...
        % ================================================
        % camera 1
        Unu1 = unc_planar_combined{1, trial_index}{combination_method_index}.x;
        Unv1 = unc_planar_combined{1, trial_index}{combination_method_index}.y;
        % camera 2
        Unu2 = unc_planar_combined{2, trial_index}{combination_method_index}.x;
        Unv2 = unc_planar_combined{2, trial_index}{combination_method_index}.y;
        ...
        [Un_u1, Un_v1, Un_w1] = stereo_uncertainty_propagation(Unu1, Unv1, Unu2, Unv2, ...
                                                                ...
                                                                mx, my);
        % store uncertainties
        unc_stereo_combined{trial_index}{combination_method_index}.x = Un_u1;
        unc_stereo_combined{trial_index}{combination_method_index}.y = Un_v1;
        unc_stereo_combined{trial_index}{combination_method_index}.z = Un_w1;            
    end
end
...
filename = fullfile(current_read_directory, 'stereo_errors_uncertainties.mat');
save(filename, 'errors', 'unc_stereo_individual', 'unc_stereo_combined');
