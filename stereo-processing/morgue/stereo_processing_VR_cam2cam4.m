...
top_write_directory = '/scratch/shannon/a/aether/Projects/PIV_PTV_Uncertainty_Quantification/uncertainty-combination/analysis/results/stereo-dataset/cam24/With_selfcal/';
...
caljobfile=load(fullfile(top_read_directory, 'Jobs', 'cam24_afterselfcalibration_job2.mat'));
...
pranajob=load(fullfile(top_read_directory, 'Results', 'Prana_process/results/cam24/With_selfcal/vortexring24_2djob.mat'));
...
planarjob.imdirec = fullfile(top_read_directory, 'Images', 'Vortex_Ring_Data/E_Particle_Images/Camera_02/');
planarjob.imdirec2 = fullfile(top_read_directory, 'Images', 'Vortex_Ring_Data/E_Particle_Images/Camera_04/');
...
%%  save jobfile
save(fullfile(top_write_directory, 'cam24_VR_prana_fulljob_withselfcal.mat'), 'caljobfile', 'planarjob', 'diroutlist', 'scaling', 'dewarp_grid', 'job1', 'job2');
