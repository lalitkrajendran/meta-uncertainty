function plot_consolidated_distance_03(results, dataset_name_array, individual_method_array, combined_method_array, combined_method_index_plot)
    ...
    for window_resolution_index = 1:num_window_resolution
        ...
        for dataset_index = 1:num_datasets
            ...
            Y = [results{window_resolution_index, dataset_index}.d_err_est_indiv, results{window_resolution_index, dataset_index}.d_err_est_comb(combined_method_index_plot)];
