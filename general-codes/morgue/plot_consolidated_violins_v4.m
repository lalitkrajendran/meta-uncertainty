function plot_consolidated_violins_v4(results, dataset_name_array, individual_method_array, combined_method_array, max_error_threshold, user_screen_resolution)
    ...
    for dataset_index = 1:num_datasets
        ...
        for violin_index = 1:num_total_methods
            ...
            elseif violin_index > 4
                ...
                % plot([violin_index, violin_index], [0, max_error_threshold], 'color', [0, 0, 0, 0.5], 'linewidth', 0.5);
                y1 = results{1, dataset_index}.unc_comb_rms(violin_index - 4);
                y2 = results{2, dataset_index}.unc_comb_rms(violin_index - 4);
            end
