...
for window_resolution_index = 1:num_window_resolution
    ...
    for dataset_index = 1:num_datasets
        ...
        if save_figures
            figure_save_directory = fullfile(current_read_directory, 'figures-rms');
        ...
        plot_unc_ratio_with_particle_removal(unc_ratio_rms, unc_ratio_rms_fit, trial_index, ppr, ...
                                            individual_method_array, resampling_method_names_plot, 'Uncertainty Ratio RMS', user_screen_resolution);
